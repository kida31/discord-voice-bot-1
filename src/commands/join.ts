...
import {CommandInteraction, DiscordAPIError, SlashCommandBuilder, type VoiceBasedChannel,} from "discord.js";
...
export default {
    data: new SlashCommandBuilder()
        ...
        .setDescriptionLocalization("de", "Dem Sprachkanal des Benutzers beitreten"),
